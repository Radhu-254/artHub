...
const ProductDetails = () => {
  ...
  return (
    <div className='mb-16 pt-44 lg:pt-[30px] xl:pt-0 bg-slate-200'>
      <div className='container mx-auto'>
        ...
        <div className='flex flex-col lg:flex-row gap-[30px] mb-[30px]'>
          ...
          <div className='flex-1 bg-white p-12 xl:p-20 rounded-lg flex flex-col justify-center'>
            {/* category title */}
            <div className='uppercase text-primary text-lg font-medium mb-2'>
              {data[0].attributes.categories.data[0].attributes.title}
            </div>
            {/* title */}
            <h2 className='h2 mb-4 text-primary font-bold'>{data[0].attributes.title}</h2>
            {/* description */}
            <p className='mb-12 text-primary font-semibold'>{data[0].attributes.description}</p>
            {/* price & btn */}
            <div className='flex-start flex-col items-center'>
              ...
              <button
                ...
                className='btn mt-4 bg-slate-400 text-white'
              >
                Add to cart
              </button>
            </div>
